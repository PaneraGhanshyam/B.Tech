...
CREATE TABLE EMPLOYEE2 (
    ...
    FOREIGN KEY (ManagerNo) REFERENCES EMPLOYEE2(EmployeeNo)
);


-- Insert data into the STUDENT table
INSERT INTO STUDENT2 (Rno, Name, Branch) VALUES
(101, 'Raju', 'CE'),
(102, 'Amit', 'CE'),
(103, 'Sanjay', 'ME'),
(104, 'Neha', 'EC'),
...
INSERT INTO EMPLOYEE2 (EmployeeNo, Name, ManagerNo) VALUES
('E01', 'Tarun', NULL),
('E02', 'Rohan', 'E02'),
('E03', 'Priya', 'E01'),
('E04', 'Milan', 'E03'),
